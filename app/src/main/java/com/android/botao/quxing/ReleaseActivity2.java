    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        img_add_photo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                menuWindow = new SelectPicPopupWindow(ReleaseActivity2.this, itemsOnClick);

                menuWindow.showAtLocation(ReleaseActivity2.this.findViewById(R.id.main), Gravity.BOTTOM | Gravity.CENTER_HORIZONTAL, 0, 0);
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(ReleaseActivity2.this, MainActivity.class);
...
//        toolbar.inflateMenu(R.menu.menu_main);
    ...
    private void init(){
        ...
        back.setImageResource(R.drawable.cmenu);
